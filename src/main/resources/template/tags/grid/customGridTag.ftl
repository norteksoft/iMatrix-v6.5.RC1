			...
			<#if listView.editable?if_exists>
				,gridComplete: function(){
					...
					for(var i=0;i < ids.length;i++){
						...
						ae = "<a href='#pos' class='small-button-bg' acttype='add' onclick='myAddRow(\"1\",\""+cl+"\",\"${tableId}\",\"${_isSubSystem}\",\"${_imatrix}\");'><span title='增加' class='ui-icon ui-icon-plusthick'></span></a>";
						if(deleteUrl!=''){
							de = "<a href='#pos' class='small-button-bg' acttype='del'  onclick='deleteFormTableData(\"${tableId}\",\""+cl+"\",\""+deleteUrl+"\",\"${_isSubSystem}\",\"${_imatrix}\");'><span title='删除' class='ui-icon  ui-icon-minusthick'></span></a>";
						}else{
							de = "<a href='#pos' class='small-button-bg' acttype='del' onclick='$deleteFormTableData(\"${tableId}\",\""+cl+"\",\"${_isSubSystem}\",\"${_imatrix}\");'><span title='删除' class='ui-icon  ui-icon-minusthick'></span></a>";
						}
						edit = "<a href='#pos' class='small-button-bg' acttype='edit' onclick=\"editClick('"+cl+"','${tableId}');\"><span title='修改' class='ui-icon  ui-icon-pencil'></span></a>";
