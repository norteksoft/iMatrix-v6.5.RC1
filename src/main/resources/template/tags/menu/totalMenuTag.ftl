...
<div id="header" class="ui-north">
	...
	<div id="honorific">
		<span><span class="man">&nbsp;</span>${honorificTitle}<#if helloVisible?if_exists>, ${hello}</#if></span>
		<#if dateVisible?if_exists>
			<span><span class="day">&nbsp;</span>${currentTime}</span>
		</#if>
		<#if passwordVisible?if_exists>
			<span onclick="updatePassword();"><a href="#"><span class="password">&nbsp;</span>${changePassword}</a></span>  
		</#if>
		<#if themeChagable?if_exists>
			<span onclick="changeStyle(event, this);"><a href="#"><span class="theme">&nbsp;</span>${changeSkin}</a></span> 
		</#if>
		<#if languageVisible?if_exists>
			<#if  "zh_CN"?contains(lanague)  >
				<span onclick="changeLanague('en_US');"><a href="#"><span class="lanagueEn">&nbsp;</span>English</a></span>
			<#else>
				<span onclick="changeLanague('zh_CN');"><a href="#"><span class="lanagueCn">&nbsp;</span>chineseName</a></span>
		 	</#if>
	 	</#if>
		<#if existable?if_exists>
			<span ><a href="${imatrixUrl}/j_spring_security_logout"><span class="exit">&nbsp;</span>${exit}</a></span> 
		</#if>
	</div>
</div>
