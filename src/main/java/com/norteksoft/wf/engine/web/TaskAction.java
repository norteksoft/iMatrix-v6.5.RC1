				...
				if(t.getProcessingMode()!=TaskProcessingMode.TYPE_READ){//表示不是抄送任务
					if(hasBranch){
						if(StringUtils.isEmpty(t.getTrustorName())){
							...
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName()+"/"+t.getTransactorSubCompanyName()+"（受托于"+t.getTrustorName()+"/"+t.getTrustorSubCompanyName()+")", "true", "false", "", "", "user", "");
						}
					}else{
						if(StringUtils.isEmpty(t.getTrustorName())){
							...
							node = new ZTreeNode("user_"+ t.getTransactorName()+"-"+t.getTransactor()+"~"+(t.getTransactorId()==null?"":t.getTransactorId())+"="+t.getId(),rootId,t.getTransactorName()+"（受托于"+t.getTrustorName()+")", "true", "false", "", "", "user", "");
						}
					}
					treeNodes.add(node);
				}
