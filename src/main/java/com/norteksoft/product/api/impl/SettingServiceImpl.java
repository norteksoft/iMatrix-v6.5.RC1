...
public class SettingServiceImpl implements SettingService{
	...
	private String getMemcachedInternationOptionValue(String code,String language,String type){
	...
	public String getInternationOptionValueByLanguage(String code, String language) {
		return getMemcachedInternationOptionValue(code,language,InternationType.PUBLIC_RESOURCE.toString());
	}
	 
	public String getInternationOptionValue(String code) {
		return getMemcachedInternationOptionValue(code,ContextUtils.getCurrentLanguage(),InternationType.PUBLIC_RESOURCE.toString());
	}
	 
	public String getInternationOptionValue(String code,String type) {
		return getMemcachedInternationOptionValue(code,ContextUtils.getCurrentLanguage(),type);
	}
	 
	public String getInternationOptionValue(String code,String language,String type) {
		return getMemcachedInternationOptionValue(code,language,type);
	}
}
