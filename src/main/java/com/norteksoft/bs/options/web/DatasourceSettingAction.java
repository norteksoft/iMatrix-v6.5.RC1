...
public class DatasourceSettingAction extends CrudActionSupport<DatasourceSetting> {
	...
	public String delete() throws Exception {
		...
		ApiFactory.getBussinessLogService().log("数据源配置", "删除数据源配置", ContextUtils.getSystemId("bs"));
	...
	public String input() throws Exception {
		ApiFactory.getBussinessLogService().log("数据源配置", "数据源配置表单页面", ContextUtils.getSystemId("bs"));
	...
	public String view() throws Exception {
		ApiFactory.getBussinessLogService().log("数据源配置", "查看数据源配置", ContextUtils.getSystemId("bs"));
	...
	public String listData() throws Exception {
		if(page.getPageSize()>1){
			ApiFactory.getBussinessLogService().log("数据源配置", "数据源配置列表", ContextUtils.getSystemId("bs"));
	...
	public String save() throws Exception {
		...
		ApiFactory.getBussinessLogService().log("数据源配置", "保存数据源配置", ContextUtils.getSystemId("bs"));
		return "datasource-input";
	}
	/**
	 * 数据源连接测试
	...
	public String dataSourceTest() throws Exception{
		...
		try {
			...
			ApiFactory.getBussinessLogService().log("数据源配置", "测试数据源", ContextUtils.getSystemId("bs"));
