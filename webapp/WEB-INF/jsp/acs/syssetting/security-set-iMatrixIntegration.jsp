				...
				<form id="inputForm" name="inputForm" action="" method="post">
					...
					<input  type="hidden" name="sysOrgAllowable" id="sysOrgAllowable" size="40" value="${serverConfig.sysOrgAllowable}" />
						<table class="form-table-without-border" style="width: auto;">
							<tr>
								<td style="300px;">操作：</td>
				                   <td><input type="checkbox" id="synInvocation1"  <s:if test="serverConfig.synImatrixInvocation">checked="checked"</s:if> onclick="synInvocationClick();"/>是否同步组织结构
				                   <input type="checkbox" id="sysOrgAllowable1"  <s:if test="serverConfig.sysOrgAllowable">checked="checked"</s:if> />是否允许其他公司同步本公司组织结构</td>
							</tr>
							<tr>
								<td style="300px;">iMatrix服务地址：</td>
				                   <td><input  type="text" id="imatrixUrl" name="imatrixUrl"  value="${serverConfig.imatrixUrl}" style="width: 200px;"  maxlength="150"/></td>
							</tr>
							<tr>
								<td style="300px;">公司编码：</td>
				                   <td><input  type="text" id="companyCode" name="companyCode"  value="${serverConfig.companyCode}" style="width: 200px;"  maxlength="50"/></td>
							</tr>
						</table>
				</form>
				<span style="color: red;">注：将该配置的iMatrix服务的组织结构同步到当前iMatrix服务的组织结构中</span>
			</div>
		</aa:zone>
	</div>
</div>  	
