...
<div class="opt-body">
				...
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="standardRoleRemoveUser"><button  class='btn' onclick="opt('ADD_USER')"><span><span>添加用户</span></span></button></security:authorize>
					<s:if test="!isAdminRole">
						<security:authorize ifAnyGranted="standardRoleRemoveUser"><button  class='btn' onclick="opt('ADD_DEPARTMENT')"><span><span>添加部门</span></span></button></security:authorize>
						<security:authorize ifAnyGranted="standardRoleRemoveUser"><button  class='btn' onclick="opt('ADD_WORKGROUP')"><span><span>添加工作组</span></span></button></security:authorize>
					</s:if>
