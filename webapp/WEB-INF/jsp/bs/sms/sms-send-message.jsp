...
<div class="opt-body">
	<div class="opt-btn">
		<a class="btn" href="#" onclick="submitSetting();"><span><span>发送</span></span></a>
	</div>
	<div id="opt-content" >
		<aa:zone name="smsSettingZone">
			...
			<form action="" name="smsSettingForm" id="smsSettingForm" method="post">
				...
				<table class="form-table-without-border">
					...
					<tr>
						<td class="content-title" style="width: 130px;">收信人：</td>
						<td> 
							<input name="receiver" style="width: 400px;" id="receiver" maxlength="500" value="${receiver }"/> 
							<a href="#"  class='btn' onclick="opt()"><span><span>添加人员</span></span></a>
					...
					<tr>
						<td class="content-title" style="width: 130px;">短信内容：</td>
						<td> 
