...
<div class="opt-body">
	<div class="opt-btn">
		<a class="btn" href="#" onclick="submitSmsGatewaySetting();"><span><span>保存</span></span></a>
		...
		<aa:zone name="smsGatewaySettingZone">
			...
			<form action="" name="smsGatewaySettingFrom" id="smsGatewaySettingFrom" method="post">
				...
				<table class="form-table-without-border">
					<tr>
						<td class="content-title">网关编号：</td>
						<td> <input name="gatewayCode" id="gatewayCode" maxlength="30" value="${gatewayCode }"/> <span class="required">*</span></td>
					</tr>
					<tr>
						<td class="content-title" style="width: 130px;">网关名称：</td>
						<td> <input name="gatewayName" id="gatewayName" maxlength="100" value="${gatewayName }"/> <span class="required">*</span></td>
					</tr>	
					<tr>
						<td class="content-title" style="width: 130px;">网关类型：</td>
						<td> 
							<select id="gatewayType" name="gatewayType" onchange="changeGatewayType();" >
								<option value="smsCat" <s:if test="gatewayType == 'smsCat'">selected="selected"</s:if>>短信猫</option>
								<option value="smsWeimi" <s:if test="gatewayType == 'smsWeimi'">selected="selected"</s:if>>微米网</option>
								<option value="smsSelf" <s:if test="gatewayType == 'smsSelf'">selected="selected"</s:if>>自定义</option>
							</select>	
					...
					<tr   >
						<td class="content-title" style="width: 130px;">报警需最大短信条数：</td>
					...
					<tr   >
						<td class="content-title" style="width: 130px;">实现类类名：</td>
