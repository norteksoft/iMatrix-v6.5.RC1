	...
	<div class="opt-body">
		<aa:zone name="groups_main">
			<div class="opt-btn">
				...
				<a class="btn" href="#" onclick="openPage('${settingCtx}/options/internation-input.htm?type=${type }','新建','create');"><span><span>新建</span></span></a>
				<a class="btn" href="#" onclick="openPage('${settingCtx}/options/internation-input.htm?type=${type }','修改','update');"><span><span>修改</span></span></a>
