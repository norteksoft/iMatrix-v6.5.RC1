...
<body>
	...
	<div class="opt-body">
		...
		<aa:zone name="groups_main">
			<div class="opt-btn">
				<a class="btn" href="#" onclick="openPage('${settingCtx}/options/job-info-timeTaskInput.htm?systemId=${systemId}','新建定时设置');"><span><span>新建</span></span></a>
				<a class="btn" href="#" onclick="updateJob('${settingCtx}/options/job-info-timeTaskInput.htm?systemId=${systemId}','修改定时设置');"><span><span>修改</span></span></a>
