						...
						<table class="form-table-without-border">
							...
							<tr>
				                ...
				                <td >
					                ...
					                <div id="tip" style="display:none">若关联子菜单，需要子下拉菜单设置的时候在每个选项后加上特殊标记以记录与父菜单关系，形如“子菜单项目|父菜单项目”，则父菜单发生变化，子菜单会随之自动刷新筛选。<font color="red">(关联子菜单不能录入“来源为选项组的下拉菜单字段名”)</font></div>
				                </td>
				             </tr>
							<tr>
