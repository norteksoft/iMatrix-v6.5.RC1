		...
		<div id="message" style="display:none;"><s:actionmessage theme="mytheme" /></div>
			<form action="" id="inputForm" name="inputForm" method="post">
				...
				<table class="form-table-without-border">
					...
					<tr>
						<td class="content-title">选择模版：</td>
						<td>
							<input type="radio" name="generateSetting.templateEnum" <s:if test="generateSetting.templateEnum==null||generateSetting.templateEnum.toString()=='TWO_COLUMN'">checked="checked"</s:if> value="TWO_COLUMN"/>2列 
							<input type="radio" name="generateSetting.templateEnum" <s:if test="generateSetting.templateEnum.toString()=='FOUR_COLUMN'">checked="checked"</s:if> value="FOUR_COLUMN"/>4列 
							<input type="radio" name="generateSetting.templateEnum" <s:if test="generateSetting.templateEnum.toString()=='SIX_COLUMN'">checked="checked"</s:if> value="SIX_COLUMN"/>6列 
						</td>
						<td></td>
					</tr>
				</table>
