...
<head>
	...
	function changeDataType(){
		...
		selectInfo+='<option value="">请选择</option>';
		var selectInfoTime='<option value="CurrentTime">当前时间</option>';
		selectInfoTime+='<option value="FixTime">指定时间</option>';
		var selectInfoDate='<option value="CurrentDate">当前日期</option>';
		selectInfoDate+='<option value="FixDate">指定日期</option>';
					...
					<tbody>
						...
						<tr>
							...
							<script type="text/javascript">
								...
								<s:select theme="simple" id="dateValueType" list="#{'':'请选择','CurrentTime':'当前时间','FixTime':'指定时间'}" 
							...
							<script type="text/javascript">
								...
								<s:select theme="simple" id="dateValueType" list="#{'':'请选择','CurrentDate':'当前日期','FixDate':'指定日期'}" 
							 					name="formControl.dataSrc" onchange="changeDateValueType();" cssStyle="width:240px;"></s:select>
							</s:elseif><s:else>
							<script type="text/javascript">
								$(function(){
