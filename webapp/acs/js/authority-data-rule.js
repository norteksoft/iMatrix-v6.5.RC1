...
function packagingOperator(dataType,conditionId,data){
	...
	if(dataType == 'TEXT'){
		...
		result+='<option '+event+' value="ET">等于</option><option value="GT">大于</option><option value="LT">小于</option><option value="GET">大于等于</option><option value="LET">小于等于</option><option value="IS_NULL">为空</option><option value="NOT_NULL">不为空</option>';
...
function packagingOperatorUpdate(dataType,conditionId,tableId){
	...
	if(dataType == 'TEXT'){
		...
		result+='<option '+event+' value="ET">等于</option><option value="GT">大于</option><option value="LT">小于</option><option value="GET">大于等于</option><option value="LET">小于等于</option><option value="NET">不等于</option><option value="IS_NULL">为空</option><option value="NOT_NULL">不为空</option>';
