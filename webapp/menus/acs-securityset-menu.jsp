...
<script type="text/javascript">
	...
	function initUserTree(){
		...
		tree.initTree({treeId:"company_user",
			data:[ 
		         	{ id:'_security_setldap', pId:0, name:"LDAP集成",iconSkin:"folder"},
		         	{ id:'_security_setiMatrix', pId:0, name:"平台自集成",iconSkin:"folder"},
		         	{ id:'_security_setrtx', pId:0, name:"RTX集成",iconSkin:"folder"},
		         	{ id:'_security_setother', pId:0, name:"其他方式集成",iconSkin:"folder"}
				],
			type:"ztree",
...
<div id="accordion1" class="basic">
	...
	<h3><a href="${acsCtx}/syssetting/security-set.action" id="_security_set" >安全参数设置</a></h3>
	<div>
		<div  id="security_set_tree" class="demo"></div>
	</div>
	<h3><a href="${acsCtx}/syssetting/security-set-integration.htm" id="_security_setldap" >集成参数设置</a></h3>
		<div>
