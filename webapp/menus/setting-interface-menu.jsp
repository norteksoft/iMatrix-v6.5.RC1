...
<div id="accordion" class="basic">
	<h3><a href="${settingCtx}/options/datasource-setting-list-data.htm" id="rank-manager">数据源配置</a></h3>
	<div></div>
	<h3><a href="${settingCtx}/options/interface-setting-list-data.htm" id="option-group">定时和接口配置</a></h3>
	<div>
