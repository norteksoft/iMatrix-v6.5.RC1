...
<script type="text/javascript">
    ...
    function treeTaskMonitor(){
		...
		tree.initTree({treeId:"treeid-taskMonitor",
			data:[{ id:'overdueTask', pId:0, name:"超期任务", iconSkin:'folder'},
			      { id:'overdueTask-active', pId:'overdueTask', name:"当前任务", iconSkin:'folder'},
			      { id:'overdueTask-history', pId:'overdueTask', name:"归档任务", iconSkin:'folder'},
			      { id:'overdueTaskUser', pId:0, name:"超期人统计",open:"true", iconSkin:'folder'},
			      { id:'overdueTaskUser-active', pId:'overdueTaskUser', name:"当前任务", iconSkin:'folder'},
			      { id:'overdueTaskUser-history', pId:'overdueTaskUser', name:"归档任务", iconSkin:'folder'}],
			type:"ztree",
	...
	function selectDefaultNode(treeId, currentId){
  	...
  	<div id="accordion" >
		...
		<h3><a href="workflow-definition-monitor-task-list.htm" id="process_monitor">超期任务监控</a></h3>
		<div>
